      ...
      <Stack direction={{xs : "column" , md : "row"}} alignItems={{xs : "center" , md : "start"}} justifyContent={"space-between"} spacing={{xs : 20 , sm : 40}} >
        <Box maxWidth={525} flex={1} >
          ...
          <Typography lineHeight={"35px"} color={"#4B4444"} fontSize={18}>
            {isEn ? "Welcome to our website Touch Tech for smartphones and mobile accessories! We offer the best prices and wonderful features for smartphones and a variety of accessories. Whether you are looking for a smartphone with an amazing camera, powerful performance, or exceptional battery life, we guarantee you will find what suits your needs and budget. Explore our diverse range of smartphones with stylish designs and intuitive interfaces. You will find a variety of smartphones at competitive prices with amazing features. Whether you are on a leisure trip or at work, you will find the perfect device to stay connected and entertained while on the go. In addition to the ability to shop wholesale and in quantities at the best price and quality, because we are the original importer. Enjoy a fun shopping experience and get the best prices for smartphones and mobile accessories on our site. We are here to serve you and meet your digital needs." : "مرحبا بكم في موقعنا تاتش تك للهواتف الذكية واكسسوارات الجوال! نحن نقدم أفضل الأسعار والمميزات الرائعة للهواتف الذكية ومجموعة متنوعة من الملحقات. سواء كنت تبحث عن هاتف ذكي مزود بكاميرا مذهلة، أو أداء قوي، أو عمر بطارية استثنائي، فإننا نضمن أنك ستجد ما يناسب احتياجاتك وميزانيتك. <br /> استكشف مجموعتنا المتنوعة من الهواتف الذكية ذات التصميمات الأنيقة والواجهات البديهية.  مجموعة متنوعة من الهواتف الذكية بأسعار تنافسية مع ميزات مذهلة. سواء كنت في رحلة ترفيهية أو في العمل، ستجد الجهاز المثالي للبقاء على اتصال ومستمتعًا أثناء التنقل. <br /> بالإضافة إلى إمكانية التسوق بالجملة وبالكميات بأفضل الأسعار والجودة لأننا المستورد الأصلي. استمتع بتجربة تسوق ممتعة واحصل على أفضل الأسعار للهواتف الذكية وملحقاتها على موقعنا. نحن هنا لخدمتك وتلبية احتياجاتك الرقمية."}
          </Typography>
        </Box>
