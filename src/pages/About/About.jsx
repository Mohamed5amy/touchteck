  ...
  return (
    <Stack pt={8} px={{xs : 10 , sm : 20 , md : 10 , lg : 70}} bgcolor={"#F8FAFC"} pb={37} >
      <Breadcrumbs separator=">" sx={{mb : 24}} >
        ...
        <Typography color="#000" variant="breadcrumbs"> من نحن </Typography>
      </Breadcrumbs>
      <Stack direction={{xs : "column" , md : "row"}} alignItems={{xs : "center" , md : "start"}} justifyContent={"space-between"} spacing={{xs : 20 , sm : 40}} >
        <Box maxWidth={525} flex={1} >
          <Typography fontSize={36} fontWeight={700} mb={8} >ماذا نقدم</Typography>
          <Typography lineHeight={"35px"} color={"#4B4444"} fontSize={18} >
          مرحبا بكم في موقعنا تاتش تك للهواتف الذكية واكسسوارات الجوال! نحن نقدم أفضل الأسعار والمميزات الرائعة للهواتف الذكية ومجموعة متنوعة من الملحقات.
          سواء كنت تبحث عن هاتف ذكي مزود بكاميرا مذهلة، أو أداء قوي، أو عمر بطارية استثنائي، فإننا نضمن أنك ستجد ما يناسب احتياجاتك وميزانيتك. <br /> استكشف مجموعتنا المتنوعة من الهواتف الذكية ذات التصميمات الأنيقة والواجهات البديهية.
          ستجد مجموعة متنوعة من الهواتف الذكية بأسعار تنافسية مع ميزات مذهلة. سواء كنت في رحلة ترفيهية أو في العمل، ستجد الجهاز المثالي للبقاء على اتصال ومستمتعًا أثناء التنقل. <br /> بالإضافة إلى إمكانية التسوق بالجملة وبالكميات بأفضل الأسعار والجودة لأننا المستورد الأصلي.
          استمتع بتجربة تسوق ممتعة واحصل على أفضل الأسعار للهواتف الذكية وملحقاتها على موقعنا. نحن هنا لخدمتك وتلبية احتياجاتك الرقمية.
          </Typography>
        </Box>
      ...
      <Grid container pt={60} spacing={15} >
        <Grid item xs={12} sm={6} md={4} lg={3}>
          <Stack height={"100%"} p={12} alignItems={"center"} justifyContent={"center"} border={"1px solid rgba(0, 0, 0, 0.30)"} borderRadius={"8px"} sx={{transition : ".5s" , "&:hover" : { borderColor : "primary.main" , translate : "0 -5px" , boxShadow : "rgba(149, 157, 165, 0.2) 0px 8px 24px" }}} >
            ...
            <Typography color={"#605353"} textAlign={"center"} > بائعون نشطون في موقعنا </Typography>
          </Stack>
        </Grid>
        <Grid item xs={12} sm={6} md={4} lg={3}>
          <Stack height={"100%"} p={12} alignItems={"center"} justifyContent={"center"} border={"1px solid rgba(0, 0, 0, 0.30)"} borderRadius={"8px"} sx={{transition : ".5s" , "&:hover" : { borderColor : "primary.main" , translate : "0 -5px" , boxShadow : "rgba(149, 157, 165, 0.2) 0px 8px 24px" }}} >
            ...
            <Typography color={"#605353"} textAlign={"center"} > مبيعات شهرية </Typography>
          </Stack>
        </Grid>
        <Grid item xs={12} sm={6} md={4} lg={3}>
          <Stack height={"100%"} p={12} alignItems={"center"} justifyContent={"center"} border={"1px solid rgba(0, 0, 0, 0.30)"} borderRadius={"8px"} sx={{transition : ".5s" , "&:hover" : { borderColor : "primary.main" , translate : "0 -5px" , boxShadow : "rgba(149, 157, 165, 0.2) 0px 8px 24px" }}} >
            ...
            <Typography color={"#605353"} textAlign={"center"} > عميل نشط في موقعنا </Typography>
          </Stack>
        </Grid>
        <Grid item xs={12} sm={6} md={4} lg={3}>
          <Stack height={"100%"} p={12} alignItems={"center"} justifyContent={"center"} border={"1px solid rgba(0, 0, 0, 0.30)"} borderRadius={"8px"} sx={{transition : ".5s" , "&:hover" : { borderColor : "primary.main" , translate : "0 -5px" , boxShadow : "rgba(149, 157, 165, 0.2) 0px 8px 24px" }}} >
            ...
            <Typography color={"#605353"} textAlign={"center"} > إجمالي المبيعات السنوية في موقعنا </Typography>
          </Stack>
        </Grid>
      </Grid>
